...
public class CategoriaController {
	...
	public ModelAndView cadastrarCategoria(@Valid CategoriaModel categoria, BindingResult bindingCategoria) {
		ModelAndView modelAndView = new ModelAndView("cadastroCategoria.html");
		...
		if(bindingCategoria.hasErrors()) {
			...
			modelAndView.addObject("mensagens", categoriaService.salvarCategoria(categoria));
		}
		return modelAndView;
	}
